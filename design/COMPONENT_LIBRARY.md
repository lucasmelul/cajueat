...
### MapPin
Marcador tipado. La recomendación principal lleva **etiqueta**; secundarios/descubrimientos son **solo punto** (relevancia sobre cantidad). `selected` → crece + anillo caju.
...
Recreación interactiva que **compone** estas primitivas (no las reimplementa): Living Map, Conversation, Restaurant Experience, Knowledge Capture, Feedback, Profile. Abrir `ui_kits/pwa/index.html`.
